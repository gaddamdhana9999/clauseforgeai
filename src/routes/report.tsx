...
export const Route = createFileRoute("/report")({
  head: () => ({
    meta: [
      { title: "Executive Report — ClauseForge AI" },
...
function ReportPage() {
  ...
  async function exportPdf() {
    ...
    doc.save(`ClauseForge_Report_${(fileName || "contract").replace(/\.[^.]+$/, "")}.pdf`);
    ...
    <div className="space-y-6 animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="card-elevated p-8 bg-card">
        <div className="border-b-4 border-gold pb-4 mb-6">
          <div className="text-xs uppercase tracking-widest text-royal font-semibold">ClauseForge AI</div>
        ...
        <div className="text-xs text-muted-foreground text-center pt-4 border-t border-border">
          Generated by ClauseForge AI · This report is informational and does not constitute legal advice.
        </div>
      </div>
    </div>
  );
